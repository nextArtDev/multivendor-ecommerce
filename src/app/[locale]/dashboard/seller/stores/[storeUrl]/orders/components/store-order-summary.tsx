...
import { getShippingDatesRange } from '@/app/[locale]/(store)/goshop/lib/utils'

import PaymentStatusTag from '@/app/[locale]/(store)/goshop/components/order-page/payment-status'
import OrderStatusSelect from './order-status-select'
import {
  OrderStatus,
  PaymentStatus,
  ProductStatus,
} from '@/app/[locale]/(store)/goshop/types'
      ...
      <div className="w-full px-1">
        ...
        <div className="mt-3 grid grid-cols-1 gap-3 py-4 border-gray-100 mb-6">
          ...
          <div>
            ...
            <h6 className="font-semibold text-lg leading-9">
              {firstName} {lastName}, {phone}, {user.phone}
            </h6>
          </div>
        </div>
        {/* Products */}
