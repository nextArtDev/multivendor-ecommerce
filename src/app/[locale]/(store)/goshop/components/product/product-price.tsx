...
const ProductPrice: FC<Props> = ({
  ...
  if (!sizeId && sizes && sizes.length > 0) {
    ...
    return (
      <div>
        <div className="text-primary inline-block font-bold leading-none mr-2.5">
          <span
        ...
        {!sizeId && !isCard && (
          <div className="text-background text-xs leading-4 mt-1">
    ...
    return (
      <div>
        ...
        {selectedSize.discount > 0 && (
          <span className="inline-block text-foreground text-xl leading-6">
