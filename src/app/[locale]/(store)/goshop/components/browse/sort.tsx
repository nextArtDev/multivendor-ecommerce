          ...
          <div className="h-9 w-[190px] md:w-[227px] !float-right">
            <div className="h-9 w-[190px] md:w-[227px] !float-left">
              ...
              >
                ...
                <ul
                  className={cn(
                    'absolute   max-h-72 py-2 shadow-2xl overflow-auto w-full transition-all duration-300 ease-in-out transform',
                    {
                ...
                >
                  {sortArray.map((option) => (
                    <li
                      key={option.query}
                      className="w-full flex items-center justify-between   hover:bg-gray-100 cursor-pointer h-8 px-4 text-xs"
