        ...
        <div className="flex flex-col gap-y-4 xl:flex-row items-center ">
          ...
          <div className="flex w-full xl:flex-1">
            <input
              ...
              className="w-full h-10 pl-6   rounded-l-full outline-none"
            />
            <span className="h-10 w-24 text-sm grid place-content-center rounded-r-full  bg-muted cursor-pointer">
              Sign up
            </span>
          </div>
        </div>
